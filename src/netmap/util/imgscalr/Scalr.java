 ...
 * algorithm presented by Chris Campbell in his <a 
 * href="http://today.java.net/pub/a/today/2007/04/03/perils-of-image-getscaledinstance.html">
 * Perils of Image.getScaledInstance()</a> article in order to give the best-looking image
...
public class Scalr {
	 ...
	 * <table cellpadding="4" border="1" summary="">
	 * <tr>
	 * <td>.0f</td>
	 * <td>.08f</td>
	 * <td>.0f</td>
	 ...
	 * 
	 * @see <a href="http://www.mail-archive.com/java2d-interest@capra.eng.sun.com/msg05621.html">
         *         How Java2D handles poorly supported image types</a>
	 * @see <a
